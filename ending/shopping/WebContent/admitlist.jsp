...
<%
 ...
 <tr height="160">
    <td width="150" align="center">
      <a href="AdminServlet?action=getDetail&gid=<%= str[6] %>">
    ...
    <td colspan="2">
      <table width="100%">
        <tr>
          <td bgcolor="#E4EDFA">
            <a href="AdminServlet?action=getDetail&gid=<%= str[6] %>"><%= str[1] %></a>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          boolean flag = DataBase.isLegal(temp);
          	...
          	{
          %>
            <a href="AdminServlet?action=delete&flag=0&gid=<%= str[6] %>">
   ...
   <tr align="center">
     ...
     %>
      ...
      %>
     	...
     	<a href="AdminServlet?action=跳转&curPage=<%= curPage-1%>"></a>
